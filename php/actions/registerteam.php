<?php
	...
	{
		function nextstep($receipient,$team_unique,$team_identifier){
			$endpoint = $server."php/actions/register_user.php?team=".$team_unique;
			...
			$message = "
             ...
             <body>
               <h2>Please Join Your Registered Team ".$team_identifier." with Xpense Hub</h2><a href='".$endpoint."'><h3>Click here to Register</h3></a>
             </body>
             </html>
             ";
		...
		if(array_walk($members,"nextstep",$tid,$tn)){
			return true;
		}else{
